...
async function newtestTokenConfigure() {
  ...
  // const ustResourceId = createResourceID(deployedContracts["42"].TestToken.newtoken, 0);
  // const routeResourceId = createResourceID(deployedContracts["42"].TestToken.token2, 0);

  // console.log("ETH resource id : "+ethResourceId);
  // console.log("ust resource id : "+ustResourceId);
  ...
  // await tx.wait(2);
  // let tx = await BridgeAddr.adminSetResource(handler[network].ERC20HandlerUpgradeable.proxy, ustResourceId, C1Addr.address);
  // await tx.wait(2);
  ...
  // await tx.wait(2);
  // tx = await BridgeAddr.adminSetFeeStatus(ustResourceId, true);
  // await tx.wait(2);
  ...
  // await tx.wait(2);
  // tx = await BridgeAddr.setBridgeFee(ustResourceId, destChain, C1Addr.address, 0, 0, true);
  // await tx.wait(2);
  ...
  // await tx.wait(2);
  let tx = await C1Addr.mint((await ethers.getSigners())[0].address, "1000000000000000000000");
  await tx.wait(2);
  // let tx = await C1Addr.mint("0x2BdE034ed5F20260908615c38B603Eef5b865df9", "1000000000000000000000");
  // await tx.wait(2);
  tx = await C2Addr.mint((await ethers.getSigners())[0].address, "1000000000000000000000");
  await tx.wait(2);
  // console.log(" Depositor balance = " + (await C1Addr.balanceOf("0x2BdE034ed5F20260908615c38B603Eef5b865df9")).toString());
