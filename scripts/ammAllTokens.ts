...
async function ammConfigure() {
  ...
  await tx.wait(2);
  //minting
  tx = await DFYN.mint((await ethers.getSigners())[0].address, "1500000000000000000000");
  await tx.wait(2);
  tx = await ROUTE.mint((await ethers.getSigners())[0].address, "1500000000000000000000");
  await tx.wait(2);
  tx = await USDT.mint((await ethers.getSigners())[0].address, "1000000000000000000000");
  await tx.wait(2);
  tx = await USDC.mint((await ethers.getSigners())[0].address, "1000000000000000000000");
  await tx.wait(2);
